    ...
    <form  method="POST">
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="nombre" type="text" value="<?= $usuarioActual['nombre']; ?>" placeholder="Coloca titulo">
            </div>

            <div class="form-group">
                <!--name: Permite a un script acceder a su contenido. -->
                <label for="titulo">Correo</label>
                <input class="form-control" name="correo" type="text" value="<?= $usuarioActual['correo']; ?>" placeholder="Coloca titulo">
            </div>
